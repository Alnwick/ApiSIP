...
public class DocumentUtilsService {
    ...
    public List<DocumentType> findRequiredTypesStatus(String processStatus) {
    ...
    public DocumentType findTypeByDescription(String typeName){
        return typeRepository.findByDescription(typeName)
                .orElseThrow(() -> new BusinessException(ErrorCode.RESOURCE_NOT_FOUND));
    }

    public DocumentStatus findStatusByDescription(String description){
    ...
    public List<DocumentStatus> getListOfStatus(List<String> statusList){
        ...
        for(String status : statusList){
            docStatusList.add(findStatusByDescription(status));
        }
